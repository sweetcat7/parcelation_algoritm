# -*- coding: utf-8 -*-
#ultima actualizacion: 08-04-2019, 2to3
...
def write_bundle( outfile, points, name): #John: Cambie esta funcion
  ...
  # wrtie minf file
  minf = """attributes = {\n    'binary' : 1,\n    'bundles' : %s,\n    'byte_order' : 'DCBA',\n    'curves_count' : %s,\n    'data_file_name' : '*.bundlesdata',\n    'format' : 'bundles_1.0',\n    'space_dimension' : 3\n  }"""
  open( outfile, 'w' ).write(minf % ( [ name, 0 ], ncount ) )
