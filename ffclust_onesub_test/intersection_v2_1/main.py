...
InTri, FnTri, InPoints, FnPoints, fib_index, fiber_class = iu.read_intersection(results_path + 'tractography-streamline-regularized-deterministic_001_21p.intersectiondata')
...
fibers_file = bundles_path + 'tractography-streamline-regularized-deterministic_001_21p.bundles'
...
iu.connectome_gifti(results_path + 'tractography-streamline-regularized-deterministic_001_21p.intersectiondata', meshes_path, parcels_gii_lh, parcels_gii_rh, results_path, 'conmatrix')
